...
<body>
	<div id="app">
		<div class="view view-main view-init safe-areas" data-master-detail-breakpoint="800" data-url="/">
			<div class="page page-home">
				...
				<div class="tabs">
					<div class="page-content tab tab-active" id="home-tab">
						<div class="card card-expandable">
							<div class="card-content">
								<div class="bg-color-deeporange" style="height: 300px">
									<div class="card-header text-color-white display-block">
										<img style="margin-top: 5px;" class="app-icon" src="img/icon.png">
										<h5 style="margin: -105px auto auto 110px;">App Name</h5>
										<h6 style="opacity: 0.7; margin: auto auto auto 110px;">App Desc.</h6>
									</div>
									...
									<button style="width: 60px; height: 30px; margin-left: 125px;" class="open-alert button button-fill button-round color-blue"><b>GET</b></button>
								</div>
						...
						<div data-slides-per-view="auto" class="swiper-container swiper-init">
							<div class="swiper-wrapper">
								...
								<a class="swiper-slide app-icon app-icon-margin link install-8ballpool">
									...
									<p class="app-name">8 Ball Pool</p>
								</a>
								<a class="swiper-slide app-icon app-icon-margin link install-pubgm">
						...
						<div data-slides-per-view="auto" class="swiper-container swiper-init">
							<div class="swiper-wrapper">
								<a href="pages/404.html" class="swiper-slide app-icon first-app link">
									<img class="app-icon" src="img/f7-icon-square.png">
									<p class="app-name">AppName</p>
								</a>
	...
	<!-- <script>
		function loadversion() {
			...
			xmlhttp.open("GET", "plists/addme.xml", true);
			xmlhttp.send();
		}
